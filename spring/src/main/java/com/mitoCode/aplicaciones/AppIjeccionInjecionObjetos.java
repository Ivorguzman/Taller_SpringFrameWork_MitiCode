...
import com.mitoCode.beans.InjeccionDeObjetos.Persona;

public class AppIjeccionInjecionObjetos {
	...
	public static void main(String[] args) {
		...
		ClassPathXmlApplicationContext appContex = new ClassPathXmlApplicationContext("beansIjeccionObjetos.xml");
