 ...
 * aplicaciones web basadas en Java. La anotación @Autowired le dice
 * a Spring que inyecte una instancia de una clase que implemente la
 * interfaz DAOJugador en el atributo daoJugador de la clase
 * ServiceJugadorImpl. Esto se llama inyección de dependencias y es
 ...
 * jugador de fútbol con sus atributos como nombre,* etc.
 * 
 ...
 * DAOJugador del paquete com.mitoCode.dao. DAO significa Data Access
 * Object y es un patrón de diseño que separa la lógica de acceso a
 * datos de la lógica de negocio. La interfaz DAOJugador define los
 * métodos que se deben implementar para interactuar con la base de
 * datos de jugadores, como registrar, actualizar, eliminar, etc. La
 * implementación concreta de esta interfaz depende del tipo de base
 * de datos que se use, por ejemplo, MySQL, MongoDB, etc.
 * public class ServiceJugadorImpl implements ServiceJugador { Esta
 * línea declara la clase ServiceJugadorImpl como pública, lo que
 * significa que se puede acceder desde cualquier otro paquete. La
 * clase implementa la interfaz ServiceJugador, lo que significa que
 * debe definir el método registrar que esta interfaz declara. La
 * interfaz ServiceJugador representa la capa de servicio de la
 ...
 * inyecte una instancia de una clase que implemente la interfaz
 ...
 * privado, lo que significa que solo se puede acceder desde la misma
 * clase. Este atributo representa la dependencia que tiene la clase
 * ServiceJugadorImpl con la capa de datos. Al usar la
 * anotación @Autowired, no hace falta inicializar este atributo con
 * un valor, ya que Spring se encarga de hacerlo.
 * 
